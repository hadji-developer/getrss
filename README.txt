...
Дамп базы данных находится в папке mysql_dump. Разумеется логин и пароль вы там должны прописать свои и желательно, чтобы
сервер базы данных слушал только localhost.
